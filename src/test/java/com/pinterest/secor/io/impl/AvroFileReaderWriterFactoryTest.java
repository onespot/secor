...
public class AvroFileReaderWriterFactoryTest {
    ...
    public void setUp() throws Exception {
        mFactory = new AvroFileReaderWriterFactory(new SecorConfig(new PropertiesConfiguration()));
    }
    ...
    public void testReadWriteRoundTrip() throws Exception {
        AvroFileReaderWriterFactory factory = new AvroFileReaderWriterFactory(new SecorConfig(new PropertiesConfiguration()));
