...
public class SequenceFileReaderWriterFactoryTest {
    ...
    private SecorConfig secorConfig = new SecorConfig(new PropertiesConfiguration());
    ...
    public void testSequenceReadWriteRoundTrip() throws Exception {
        SequenceFileReaderWriterFactory factory = new SequenceFileReaderWriterFactory(secorConfig);
